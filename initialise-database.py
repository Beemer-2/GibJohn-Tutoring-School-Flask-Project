...
db_cursor.execute("CREATE TABLE users (username VARCHAR UNIQUE, password VARCHAR, ID INT UNIQUE, email VARCHAR, phoneNum INT, creationDate DATETIME, lessonsOwned VARCHAR, salt VARCHAR)")
database.commit()
database.close()
